...
_METRICGROUPPARAM = _descriptor.Descriptor(
  name='MetricGroupParam',
  full_name='mlflow.MetricGroupParam',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.MetricGroupParam.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.MetricGroupParam.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METRICGROUPENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.MetricGroupEntry.value', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METRICGROUP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entries', full_name='mlflow.MetricGroup.entries', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOGMETRICGROUP_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='mlflow.LogMetricGroup.Response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LOGMETRICGROUP = _descriptor.Descriptor(
  name='LogMetricGroup',
  full_name='mlflow.LogMetricGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_uuid', full_name='mlflow.LogMetricGroup.run_uuid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='mlflow.LogMetricGroup.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='params', full_name='mlflow.LogMetricGroup.params', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='mlflow.LogMetricGroup.value', index=3,
      ...
      serialized_options=_b('\210\265\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='mlflow.LogMetricGroup.timestamp', index=4,
      number=5, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_LOGMETRICGROUP_RESPONSE, ],
  enum_types=[
  ],
  serialized_options=_b('\342?(\n&com.databricks.rpc.RPC[$this.Response]'),
  is_extendable=False,
...
_METRICGROUPENTRY.fields_by_name['params'].message_type = _METRICGROUPPARAM
...
_LOGMETRICGROUP_RESPONSE.containing_type = _LOGMETRICGROUP
_LOGMETRICGROUP.fields_by_name['params'].message_type = _METRICGROUPPARAM
...
DESCRIPTOR.message_types_by_name['MetricGroupParam'] = _METRICGROUPPARAM
...
DESCRIPTOR.message_types_by_name['LogMetricGroup'] = _LOGMETRICGROUP
...
MetricGroupParam = _reflection.GeneratedProtocolMessageType('MetricGroupParam', (_message.Message,), dict(
  DESCRIPTOR = _METRICGROUPPARAM,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.MetricGroupParam)
  ))
_sym_db.RegisterMessage(MetricGroupParam)
...
LogMetricGroup = _reflection.GeneratedProtocolMessageType('LogMetricGroup', (_message.Message,), dict(

  Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), dict(
    DESCRIPTOR = _LOGMETRICGROUP_RESPONSE,
    __module__ = 'service_pb2'
    # @@protoc_insertion_point(class_scope:mlflow.LogMetricGroup.Response)
    ))
  ,
  DESCRIPTOR = _LOGMETRICGROUP,
  __module__ = 'service_pb2'
  # @@protoc_insertion_point(class_scope:mlflow.LogMetricGroup)
  ))
_sym_db.RegisterMessage(LogMetricGroup)
_sym_db.RegisterMessage(LogMetricGroup.Response)
...
_METRICGROUPENTRY.fields_by_name['value']._options = None
_METRICGROUPENTRY.fields_by_name['timestamp']._options = None
_METRICGROUP.fields_by_name['key']._options = None
_METRICGROUP.fields_by_name['entries']._options = None
...
_LOGMETRICGROUP.fields_by_name['run_uuid']._options = None
_LOGMETRICGROUP.fields_by_name['key']._options = None
_LOGMETRICGROUP.fields_by_name['value']._options = None
_LOGMETRICGROUP.fields_by_name['timestamp']._options = None
_LOGMETRICGROUP._options = None
...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='logMetricGroup',
    full_name='mlflow.MlflowService.logMetricGroup',
    index=11,
    containing_service=None,
    input_type=_LOGMETRICGROUP,
    output_type=_LOGMETRICGROUP_RESPONSE,
    serialized_options=_b('\202\265\030I\n3\n\004POST\022%/preview/mlflow/runs/log-metric-group\032\004\010\002\020\001\020\001*\020Log Metric Group'),
  ),
  _descriptor.MethodDescriptor(
    name='logParam',
